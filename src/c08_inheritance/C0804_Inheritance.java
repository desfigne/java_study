...
//		JAVA0802Person p2 = new JAVA0802Person("김유신", "종로구", "010-5678-5678", 12);
		C0802_Person kim = new C0802_Person("김유신", "종로구", "010-5678-5678", 12);
...
//		JAVA0803Animal cat = new JAVA0803Animal("야옹이", 6, p2);
		C0803_Animal dog = new C0803_Animal("명수", 5, lee);
		C0803_Animal cat = new C0803_Animal("야옹이", 6, kim);
