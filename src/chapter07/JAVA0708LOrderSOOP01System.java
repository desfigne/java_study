...
public class JAVA0708LOrderSOOP01System {
	...
	JAVA0708LOrderSOOP03LunchMenu[] lunchMenuList = new JAVA0708LOrderSOOP03LunchMenu[4]; // 주문할 메뉴 : LunchMenu
	JAVA0708LOrderSOOP04LunchOrderItem[] orderItemList = new JAVA0708LOrderSOOP04LunchOrderItem[4];
	JAVA0708LOrderSOOP05LunchPaymentItem paymentItem;
	int orderCount = 0;
	...
	public void createLunchMenu() {
	    for(int i = 0; i < lunchMenuNames.length; i++ ) {
	    	...
	    	JAVA0708LOrderSOOP03LunchMenu menu = new JAVA0708LOrderSOOP03LunchMenu();
	    	//
	    	menu.no = i + 1;
...
//    }
    public void showLunchMenu() {
    	System.out.println("******************************************");
	    for (JAVA0708LOrderSOOP03LunchMenu menu : lunchMenuList) {
	...
	public int searchOrderItemIdx(int lunchMenu) {
		...
		for (int i = 0; i < orderCount; i++ ) {
			JAVA0708LOrderSOOP04LunchOrderItem orderItem = orderItemList[i];
...
//		}
		for(JAVA0708LOrderSOOP04LunchOrderItem orderItem : orderItemList) {
	...
	public void order(int lunchMenu) {
		...
		for(JAVA0708LOrderSOOP03LunchMenu menu : lunchMenuList) {
			if(menu.no == lunchMenu) {
				...
				if(idx == -1) {
					orderItemList[orderCount] = new JAVA0708LOrderSOOP04LunchOrderItem();
		...
		if(orderCount == 0) {
            ...
            if (scan.hasNextInt()) {
                ...
                if (amount >= total) {
                    ...
                    paymentItem = new JAVA0708LOrderSOOP05LunchPaymentItem();
