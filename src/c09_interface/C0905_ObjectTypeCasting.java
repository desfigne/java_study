...
public class C0905_ObjectTypeCasting {

	public static void main(String[] args) {

		C0903_Circle yellowC = new C0903_Circle("노랑", 1);
		C0903_Rectangle blueR = new C0903_Rectangle("파랑", 1, 2);
		C0901_Shape s = new C0903_Circle("초록색", 2); // 자동(묵시적) 형변환
...
//		I03Circle cs = s;
		C0903_Circle cs = (C0903_Circle)s; // 강제(명시적) 형변환 O
		
		C0901_Shape s2 = new C0901_Shape("빨강"); // 쉐입으로 스택에 생성되고 쉐입만 구성됨
...
//		s.color; // 프로텍티드로 인해 접근 불가가 아닌 이클립스가 단순 호출은 의미가 없다 알리며 빨간 줄 표시됨
		...
		C0902_Interface si2 = new C0903_Rectangle("파란색", 10, 11);
		C0902_Interface si3 = new C0903_Triangle("민트색");
