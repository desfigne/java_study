package part02_follow.chapter07_class.C0718_Kbank_v01teach;

import part02_follow.chapter07_class.C0718_Kbank_v01teach.AccountPaperVo;
import part02_follow.chapter07_class.C0718_Kbank_v01teach.AccountVo;
...
public class BankMan {
	...
	public AccountVo[] createAccountList() {
		...
		for(int i = 0; i < names.length; i++) {
			...
			list[i] = account; // 안만들면 널포인트익셉션 에러 뜸
		}
		return list;
	}
