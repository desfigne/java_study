...
public class C0706_SSMS_V0302_System {
	...
	C0703_SSMS_V0201_Student[] sList = new C0703_SSMS_V0201_Student[10];
	int count = 0;
...
//        menuCheck(menu);
	...
	public void insert() {
		...
		System.out.println("=============================================");
		sList[count] = new C0703_SSMS_V0201_Student();
	...
	public void showList() {
		if (count != 0) {
			...
			for(C0703_SSMS_V0201_Student student : sList) {
	...
	public int searchIndex(String pname) {
		...
		for(int i=0; i<count; i++) {
			C0703_SSMS_V0201_Student student = sList[i];
