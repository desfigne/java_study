...
//		int[] arrInt4 = new int[3]; // Arrays.copyOf(), 새로 생성하기에 정의할 필요 없음
...
//		System.arraycopy(원본, 0, 복제본, 0, 0); // 2번째는 시작점, 3번째는 도착점
...
//		public static boolean[] copyOf(int[] original, int newLength)
