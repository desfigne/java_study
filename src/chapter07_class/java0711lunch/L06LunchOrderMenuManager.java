package chapter07_class.java0711lunch;

public class L06LunchOrderMenuManager {
...
//	}
	...
	// Constructor
	public L06LunchOrderMenuManager() {}
	public L06LunchOrderMenuManager(L01System system) {
	...
	public void createLunchMenu() {
	    for(int i = 0; i < mgmsystem.lunchMenuNames.length; i++ ) {
	    	...
	    	L03LunchMenu menu = new L03LunchMenu();
	    	//
	    	menu.no = i + 1;
...
//    }
    public void showLunchMenu() {
    	System.out.println("******************************************");
	    for (L03LunchMenu menu : mgmsystem.lunchMenuList) {
