...
public class C0699_StudentScoreMgmSystem_V0102_System {

	Scanner scan = new Scanner(System.in);
	int menu;
	int count = 0;
	final int MAX = 100;
	C0699_StudentScoreMgmSystem_V0103_Student[] students = new C0699_StudentScoreMgmSystem_V0103_Student[MAX];
	...
	public void registerStudent() {
		...
		C0699_StudentScoreMgmSystem_V0103_Student s = new C0699_StudentScoreMgmSystem_V0103_Student();
		System.out.print("학번: ");
	...
	public void listStudents() {
		...
		for (int i = 0; i < count; i++) {
			C0699_StudentScoreMgmSystem_V0103_Student s = students[i];
